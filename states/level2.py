...
class Level2:
    def __init__(self, game):
        ...
        self.enemies = [
            ...
            Enemy(300, 300, 50, 50, 'vespa', dificuldade=1),
            Enemy(300, 300, 50, 50, 'besouro', dificuldade=2),
            Enemy(500, 100, 50, 50, 'mosca', dificuldade=2),
            Enemy(500, 100, 50, 50, 'mosca', dificuldade=2),
            Enemy(500, 100, 50, 50, 'besouro', dificuldade=3),
        ]
    ...
    def update(self):
        ...
        if self.player.vida <= 0:
            ...
            self.game.change_state(Defeat(self.game, 2))  # Ajuste o nível conforme necessário

        if not self.enemies:
            from states.victory import Victory
            self.perfil_jogador.niveis_completados['nivel2'] = True
            self.perfil_jogador.salvar_progresso()
            self.game.change_state(Victory(self.game, 2))
    ...
    def draw(self):
        ...
        # Desenhar a vida do jogador com porcentagem abaixo do botão
        ...
        # Desenhar informações sobre as capturas
