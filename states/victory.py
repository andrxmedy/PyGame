...
class Victory:
    ...
    def draw(self):
        ...
        victory_text = self.font.render(f'VOCÊ VENCEU O NÍVEL {self.level}', True, text_color)
        text_rect = victory_text.get_rect(center=(WINDOW_WIDTH / 2, WINDOW_HEIGHT / 2 - 20))
        self.game.screen.blit(victory_text, text_rect)
